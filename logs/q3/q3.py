...
files = {
    "Random No Cache": "./random/csvs/q3-random-no-cache.csv",
    "Random 10% Cache": "./random/csvs/q3-random-10-cache.csv",
    "Random 20% Cache": "./random/csvs/q3-random-20-cache.csv",
    "Random 50% Cache": "./random/csvs/q3-random-50-cache.csv",
    "Random 100% Cache": "./random/csvs/q3-random-100-cache.csv",
    "Zipfian No Cache": "./zipfian/csvs/q3-zipfian-no-cache.csv",
    "Zipfian 10% Cache": "./zipfian/csvs/q3-zipf-10.csv",
    "Zipfian 20% Cache": "./zipfian/csvs/q3-zipf-20.csv",
    "Zipfian 50% Cache": "./zipfian/csvs/q3-zipf-50.csv",
    "Zipfian 100% Cache": "./zipfian/csvs/q3-zipf-100.csv"
}
...
for name, df in dataframes.items():
    ...
    stats[name] = {"mean": mean, "std_dev": std_dev}
...
cache_sizes = ['No Cache', '10%', '20%', '50%', '100%']
...
for idx, row in random_df.iterrows():
    print(f"{idx}: Mean = {row['mean']:.3f}ms, Std Dev = {row['std_dev']:.3f}ms")
